...
/obj/item/device/helmet_visor/night_vision/activate_visor(obj/item/clothing/head/helmet/marine/attached_helmet, mob/living/carbon/human/user)
	...
	if(user.client?.prefs?.night_vision_color)
		matrix_color = user.client.prefs.nv_color_list[user.client.prefs.night_vision_color]
...
/obj/item/device/helmet_visor/po_visor
	...
	hud_type = null
	toggle_on_sound = 'sound/handling/smartgun_open.ogg'
	toggle_off_sound = 'sound/handling/smartgun_close.ogg'

/obj/item/device/helmet_visor/po_visor/proc/can_attach_to(obj/item/clothing/head/helmet/marine/target_helmet)
