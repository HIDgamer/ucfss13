...
/// Legacy casing of the USCM MRE box typepath. Existing map files still place it by this name, so it
/// stays as an alias of the renamed type rather than editing every map that references it.
/obj/item/storage/box/MRE
	parent_type = /obj/item/storage/box/mre

/// Legacy typepaths for the pre-unification USCM/W-Y MRE boxes, kept for the same reason as above.
/obj/item/storage/box/uscm_mre
	parent_type = /obj/item/storage/box/mre

/obj/item/storage/box/wy_mre
	parent_type = /obj/item/storage/box/mre/wy
