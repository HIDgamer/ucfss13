...
GLOBAL_LIST_INIT(cm_vending_clothing_synth, list(
		...
		list("S-V42A1 Smartpack, Dark Blue", 0, /obj/item/storage/backpack/marine/smartpack/a1/darkblue, MARINE_CAN_BUY_BACKPACK, VENDOR_ITEM_REGULAR),
...
GLOBAL_LIST_INIT(cm_vending_clothing_synth_snowflake, list(
	...
	list("Marine Helmet (Urban)", 12, /obj/item/clothing/head/helmet/marine/urban, null, VENDOR_ITEM_REGULAR),
	...
	list("Technician Helmet (Urban)", 12, /obj/item/clothing/head/helmet/marine/tech/urban, null, VENDOR_ITEM_REGULAR),
	list("Technician Helmet (Jungle)", 12, /obj/item/clothing/head/helmet/marine/tech/jungle, null, VENDOR_ITEM_REGULAR),
	list("Technician Helmet (Snow)", 12, /obj/item/clothing/head/helmet/marine/tech/snow, null, VENDOR_ITEM_REGULAR),
	list("Technician Helmet (Desert)", 12, /obj/item/clothing/head/helmet/marine/tech/desert, null, VENDOR_ITEM_REGULAR),
	list("Corpsman Helmet", 12, /obj/item/clothing/head/helmet/marine/medic, null, VENDOR_ITEM_REGULAR),
	list("Corpsman Helmet (Urban)", 12, /obj/item/clothing/head/helmet/marine/medic/urban, null, VENDOR_ITEM_REGULAR),
	list("Corpsman Helmet (Jungle)", 12, /obj/item/clothing/head/helmet/marine/medic/jungle, null, VENDOR_ITEM_REGULAR),
	list("Corpsman Helmet (Snow)", 12, /obj/item/clothing/head/helmet/marine/medic/snow, null, VENDOR_ITEM_REGULAR),
	list("Corpsman Helmet (Desert)", 12, /obj/item/clothing/head/helmet/marine/medic/desert, null, VENDOR_ITEM_REGULAR),
...
/obj/structure/machinery/cm_vending/own_points/experimental_tools/redeem_token(obj/item/coin/marine/token, mob/user)
	if(token.token_type == VEND_TOKEN_SYNTH)
		if(user.drop_inv_item_to_loc(token, src))
			available_points = istype(token, /obj/item/coin/marine/synth/sam) ? 120 : 60
...
GLOBAL_LIST_INIT(cm_vending_synth_tools, list(
	...
	list("PK-130 LTM", 10, /obj/item/device/simi_chip/live_tactical_map, null, VENDOR_ITEM_REGULAR),
