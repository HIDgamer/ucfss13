...
/obj/structure/machinery/floodlight/landing/dropship_airlock
	...
	// Unlike the outdoor-LZ /landing parent, this is an indoor hangar fixture - it should respond
	// to the area losing power and be switchable, not stay permanently lit regardless of darkness.
	needs_power = TRUE
	toggleable = TRUE
