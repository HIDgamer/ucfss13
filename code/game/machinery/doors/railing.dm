...
/obj/structure/machinery/door/poddoor/railing/dropship_airlock
	density = FALSE
...
/obj/structure/machinery/door/poddoor/railing/dropship_airlock/Initialize(mapload, ...)
	. = ..()
	return INITIALIZE_HINT_LATELOAD

/obj/structure/machinery/door/poddoor/railing/dropship_airlock/LateInitialize()
	. = ..()
...
/obj/structure/machinery/door/poddoor/railing/dropship_airlock/Destroy()
	if(linked_inner)
		linked_inner.railings -= src
	. = ..()

/obj/structure/machinery/door/poddoor/railing/dropship_airlock/almayer_one
	linked_inner_dropship_airlock_id = ALMAYER_HANGAR_AIRLOCK_ONE

/obj/structure/machinery/door/poddoor/railing/dropship_airlock/almayer_two
