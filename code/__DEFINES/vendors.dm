...
#define MARINE_CAN_BUY_SAM_TOKEN "sam_token"
...
#define VEHICLE_SPECIAL_AVAILABLE 64

#define VEHICLE_ALL_AVAILABLE (VEHICLE_INTEGRAL_AVAILABLE|VEHICLE_PRIMARY_AVAILABLE|VEHICLE_SECONDARY_AVAILABLE|VEHICLE_SUPPORT_AVAILABLE|VEHICLE_ARMOR_AVAILABLE|VEHICLE_TREADS_AVAILABLE|VEHICLE_SPECIAL_AVAILABLE)
...
#define VEND_TOKEN_SAM "HIDgamer"
