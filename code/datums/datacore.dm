...
/datum/datacore
	...
	var/locked[] = list()
	/// Tracks leveled rifleman distribution
	var/leveled_riflemen = 0
	/// Max leveled riflemen before down-ranking
	var/leveled_riflemen_max = 3
...
/proc/get_id_photo(mob/living/carbon/human/H)
	...
	clothes_s = new /icon('icons/mob/humans/underwear.dmi', "marine_underpants_s")
