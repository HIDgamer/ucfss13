...
GLOBAL_LIST_INIT_TYPED(huds, /datum/mob_hud, list(
    new /datum/mob_hud/security/basic(),
    new /datum/mob_hud/security/advanced(),
    new /datum/mob_hud/medical/basic(),
    new /datum/mob_hud/medical/advanced(),
    new /datum/mob_hud/medical/observer(),
    new /datum/mob_hud/xeno_infection(),
    new /datum/mob_hud/xeno(),
    new /datum/mob_hud/xeno_hostile(),
    new /datum/mob_hud/faction(),
    new /datum/mob_hud/faction/observer(),
    new /datum/mob_hud/faction/upp(),
    new /datum/mob_hud/faction/wy(),
    new /datum/mob_hud/faction/twe(),
    new /datum/mob_hud/faction/clf(),
    new /datum/mob_hud/faction/pmc(),
    new /datum/mob_hud/faction/cmb(),
    new /datum/mob_hud/faction/nspa(),
    new /datum/mob_hud/hunter_hud(),
