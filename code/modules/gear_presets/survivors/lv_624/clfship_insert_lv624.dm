...
/datum/equipment_preset/survivor/clf/proc/add_ice_colony_rebel_equipment(mob/living/carbon/human/new_human)
	spawn_rebel_uniform(new_human)
	spawn_rebel_suit(new_human)
	spawn_rebel_helmet(new_human)
	spawn_rebel_shoes(new_human)
...
/datum/equipment_preset/survivor/clf/coordinator/load_gear(mob/living/carbon/human/new_human)
	...
	new_human.equip_to_slot_or_del(new /obj/item/storage/backpack/lightpack(new_human), WEAR_BACK)
	new_human.equip_to_slot_or_del(new /obj/item/storage/box/uscm_mre(new_human), WEAR_IN_BACK)
	new_human.equip_to_slot_or_del(new /obj/item/storage/firstaid/adv(new_human), WEAR_IN_BACK)
	...
	new_human.equip_to_slot_or_del(new /obj/item/device/motiondetector/hacked(new_human), WEAR_IN_BACK)
