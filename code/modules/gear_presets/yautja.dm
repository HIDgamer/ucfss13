...
/datum/equipment_preset/yautja/youngblood_leader
	name = "Yautja Youngblood Leader"
	flags = EQUIPMENT_PRESET_START_OF_ROUND
	clan_rank = CLAN_RANK_UNBLOODED_INT

/datum/equipment_preset/yautja/non_wl
	name = "Yautja Youngblood"
	clan_rank = CLAN_RANK_UNBLOODED_INT

/datum/equipment_preset/yautja/non_wl_leader
	name = "Yautja Youngblood Leader"
	clan_rank = CLAN_RANK_UNBLOODED_INT
