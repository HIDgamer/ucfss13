...
/obj/item/weapon/gun/flamer
	...
	/// Sound played when the flamer is ignited (turned on)
	var/ignite_sound
	/// Sound played when the flamer is extinguished (turned off)
	var/extinguish_sound
	/// Sound(s) played when trying to fire with an empty/no fuel tank
	var/dry_fire_sound
