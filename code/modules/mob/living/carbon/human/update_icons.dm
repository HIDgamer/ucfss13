...
/mob/living/carbon/human/proc/update_body()
	...
	if(species.flags & HAS_UNDERWEAR)
		...
		var/datum/sprite_accessory/underwear/underwear_datum = GLOB.underwear_m[underwear] || GLOB.underwear_f[underwear]
		if(underwear_datum)
		...
		var/datum/sprite_accessory/underwear/undershirt_datum = GLOB.undershirt_m[undershirt] || GLOB.undershirt_f[undershirt]
		if(undershirt_datum)
