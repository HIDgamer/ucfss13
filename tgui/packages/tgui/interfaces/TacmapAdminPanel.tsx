...
type Data = {
  ...
  map_fallback: string | null;
  last_update_time: number;
};

type FactionPageProps = {
  readonly ckeys: string[];
  readonly names: string[];
  readonly times: string[];
  readonly selected_map: number;
  readonly is_uscm: boolean;
};

type Page = {
  title: string;
  component: () => (props: FactionPageProps) => React.ReactNode;
  color: string;
  icon: string;
...
const FactionPage = (props: FactionPageProps) => {
  const { act } = useBackend<Data>();
  const { ckeys, names, times, selected_map, is_uscm } = props;
